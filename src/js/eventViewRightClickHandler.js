var EventViewRightClickHandler = {
  ...
  createOptionInEventEditor: function () {
    ...
    // option text
    var option = EventView.eventEditorSvg.append("g").attr("class", "options");
    option
      .append("text")
      .attr("x", 5)
  ...
  drawOptionButton: function (text, translateX, translateY) {
    ...
    var button = EventView.eventEditorSvg
      .select(".options")
      .append("g")
      .attr("class", "button")
    ...
    if (text == "S") {
      backgroundRect.style("rx", 0).style("ry", 0);
    }
